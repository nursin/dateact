          ...
          <div className="col-12">
            <div className="card custom-card">
              ...
              <div className="card-body col">
                ...
                <div id="quirky-fact" className="col-12 mt-1 text-left"><strong>Quirky fact: </strong>{generateProfile(this.props.data.formValues.charType, this.props.data, 'quirkyFact', randomFamousPerson)}</div>
